...
- 참고: 아래 예제는 .NET Framework에서만 동작한다. 
- 참고: [***.NET Core/5+ 에서 동작하는 동적 컴파일 기법***](https://github.com/icodes-studio/wiki/blob/main/STUDY%2BRND/.NET%20Reflection/.NET%20Reflection%20%2302.md#25-net-core5%EC%97%90%EC%84%9C-c-%EC%BD%94%EB%93%9C%EB%A5%BC-%EB%8F%99%EC%A0%81%EC%9C%BC%EB%A1%9C-%EC%BB%B4%ED%8C%8C%EC%9D%BC%EC%82%AC%EC%9A%A9%ED%95%98%EB%8A%94-%EB%B0%A9%EB%B2%95)
    ```
    using System;
