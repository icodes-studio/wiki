...
- Runtime weaving이라고도 부름
    ...
    public class Example
    {
        ...
        static T CreateProxy<T>() where T : class, new()
        {
            ...
            var PropertyChanged = type.DefineField("PropertyChanged", typeof(PropertyChangedEventHandler), FieldAttributes.Private);
            ...
            // STEP 1. generate add_PropertyChanged method code
            {
                ...
                il.Emit(OpCodes.Stfld, PropertyChanged);
                il.Emit(OpCodes.Ret);
            }
