...
- 새로운 방식
    ...
    ```
- ***See Also***
    - [***Initializers for auto-properties***](https://github.com/icodes-studio/wiki/blob/main/STUDY%2BRND/Begining%20C%23/%5BC%23%5D%2006.0%20summary.md#111-initializers-for-auto-properties)
...
- 나이 순으로 정렬 - 내림차순
    ```
    var ageSordDesc = from person in people
...
- 여러개의 from 절을 포함하는 쿼리식은 SelectMany 메서드로 변환된다.
    ...
    ```
- 컬렉션 안에 다른 컬렉션이 있을 때, 자식 컬렉션의 각 항목을 열거해야 하는 경우에 사용한다.
- SelectMany 3가지 오버로드
    ```
