...
- 메서드의 지역 변수 선언을 타입에 관계없이 var 예약어로 쓸 수 있다.
    ...
    ```
- ***See Also***
    - ***EffectiveC# - 지역변수를 선언할 때는 var를 사용하는 것이 낫다.***
...
- ***See Also***
    ...
    - ***C# 6.0 - extension method "Add" for a collection***
...
- partial class와 비슷하게 메서드를 나누어 구현할 수 있는 방식
    ...
    ```
- 부분 메서드의 제약 조건이 몇개 있었는데, C# 9.0에서 모두 없어졌다.
- ***See Also***
...
- ***See Also***
    ...
    - ***Effective C# - Action, Predicate, Function과 순회 방식을 분리하라***
