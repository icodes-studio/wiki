...
- See the [CLI tools section](https://www.rabbitmq.com/install-windows.html#cli) and the [Monitoring and Health Checks guide](https://www.rabbitmq.com/monitoring.html) to learn more.
