...
- ***The AssetBundle File***
    - 애셋번들 파일은 다수의 파일을 내부적으로 포함하는 아카이브 형태이다.
...
- ***Consider the following example...***
    - 번들 1의 머티리얼이 번들 2에 있는 텍스쳐를 참조하는 경우,
    - 번들 1에 참조하는 텍스쳐가 복사되어 들어가지 않는다. 그저 종속성이 생기게 된다.
    - 즉, 번들 1에 있는 머티리얼을 로딩하기 전에 번들 2를 로딩해야 한다.
